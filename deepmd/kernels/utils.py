...
def assert_triton_supported_gpu(
    ...
    raise RuntimeError(
        ...
        "For LAMMPS, DPA4 requires a Volta-or-newer GPU. There is no "
        "override for the torch.compile path on Pascal -- use the dense "
        "eager path on this GPU, or run on a Volta-or-newer GPU."
    )
